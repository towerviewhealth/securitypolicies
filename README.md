# TowerView Health HIPAA Compliance Policies

HIPAA compliance is complicated, but it doesn't have to be. TowerView Health helps relieve the technical burden with our HIPAA-compliant cloud computing platform and solutions for healthcare.
...
2. When ready, download the policies and comb through for mentions of TowerView Health or our business and change to appropriate references to your company.
3. Publish your policies in a publicly available location. The files are markdown, so you may need to convert to HTML if you don't have a publishing platform capable of markdown format. You can either create an index page linking to each individual policy, or create a single page listing all the policies in line, [much like we did](https://towerviewhealth.com/policy/).

## Who is behind this?

[towerviewhealth.com](htts://towerviewhealth.com), healthcare's trusted HIPAA-compliant platform.

We help companies who handle PHI, both business associates and covered entities, maintain compliance with our Platform as a Service ([Stratum](https://towerviewhealth.com/stratum)) and Managed Data Integration Services ([Redpoint](https://towerviewhealth.com/redpoint)). 

To get in touch, shoot us an email at [hello@towerviewhealth.com](mailto:hello@towerviewhealth.com). We'd love to hear from you!
