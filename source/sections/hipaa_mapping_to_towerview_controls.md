# HIPAA Mappings to TowerView Health Controls

Below is a list of HIPAA Safeguards and Requirements and the TowerView Health controls in place to meet those.

| **Administrative Controls** HIPAA Rule | TowerView Health Control
--- | ---
...
| **Physical Safeguards** HIPAA Rule | TowerView Health Control
--- | ---
...
| **Technical Safeguards** HIPAA Rule | TowerView Health Control
---------------- | ----------------
